...
def main():
    ...
    if page == "Lander":
        st.title("FINANCE FLOW")
        st.header("Budgeting Made Effortless: Control Your Money, Transform Your Life.")
        st.write("Welcome to FINANCE FLOW – the ultimate solution for mastering your finances effortlessly!")
        st.write("Are you tired of feeling stressed about money? Do you want to take control of your financial future? Look no further – FINANCE FLOW is here to help you achieve your financial goals and live the life you've always dreamed of.")
        st.write("With FINANCE FLOW , budgeting becomes a breeze. Say goodbye to guesswork and hello to clarity as you effortlessly track every dollar you spend. Our intuitive interface makes it easy to categorize your expenses, set savings goals, and monitor your progress – all in one convenient place.")
    ...
    if page == "Home":
        st.header("Welcome to FINANCE FLOW - Budget Tracking and Analysis App")
            ...
            if st.button("Log In"):
                if user_login and pass_login:
                    ...
                    if user:
                        ...
                        st.info("Go Back to Home Page to continue")
